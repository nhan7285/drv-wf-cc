namespace VegunSoft.Schedule.App
{
    partial class FSchedulePersonnel
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.ribbonControl.Items.AddRange(new DevExpress.XtraBars.BarItem[] { this.ribbonControl.ExpandCollapseItem, this.iExit, this.iHelp, this.iAbout, this.siStatus, this.siInfo, this.rgbiPalettes, this.ddbiSkins });
